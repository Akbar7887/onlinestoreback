...
public class UserDetailsImpl implements UserDetails {
    ...
    public UserDetailsImpl(Long id, String username, String password, String phone, String email, Date dateCreate, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
